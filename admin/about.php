...
<div class="wrap" style="padding: 10px">
	...
	<p>Features:</p>
	<ul><li>Drag and drop images from anywhere on the Internet into the Snipi Toolbar and have them automatically sent to WordPress.<li>
	...
	<li>Use the Snipi iPhone app to view all of your products, photos and videos - on the go.<li></ul>
</div>
<div class="wrap" style="padding: 10px">
	<h2>Installation</h2>
...
<div class="wrap" style="padding: 10px">	
    ...
    <p>However it's physically impossible to test our plugin with all possible configurations.</p>

...
Plugin URI: http://www.snipi.com/wordpress/
Description: Drag and drop images into the Snipi Toolbar and they automatically appear in your WordPress Media Library or NextGen Gallery. <a href="admin.php?page=wp_snipi">Configure</a>.  Get the toolbar (<a href="http://www.snipi.com">www.snipi.com</a>). 
Author: Snipi, Inc <info@snipi.com>
Version: 1.0.3
Author URI: http://snipi.com/tour/view/toolbar
*/
/**
 * Plugin to upload images from Snipi.com to word press gallery
 * @package wp_snipi
